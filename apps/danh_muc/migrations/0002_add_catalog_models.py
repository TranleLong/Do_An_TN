# Generated migration file to add catalog models used by warehouse and sales apps.
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nuoc_san_xuat', models.CharField(blank=True, max_length=100, verbose_name='Nước sản xuất')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('don_vi_tinh', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='danh_muc.donvitinh', verbose_name='Đơn vị tính')),
                ('nhom_hang', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='danh_muc.nhomhang', verbose_name='Nhóm hàng')),
                ('thuong_hieu', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='danh_muc.thuonghieu', verbose_name='Thương hiệu')),
            ],
            options={
